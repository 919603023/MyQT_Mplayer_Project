...
QT_MOC_LITERAL(1, 14, 24), // "QPushButonMysignalsLeave"
QT_MOC_LITERAL(2, 39, 0), // ""
QT_MOC_LITERAL(3, 40, 24) // "QPushButonMysignalsEnter"

    },
    "MyQPushButton\0QPushButonMysignalsLeave\0"
    "\0QPushButonMysignalsEnter"
};
...
void MyQPushButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MyQPushButton *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->QPushButonMysignalsLeave(); break;
        case 1: _t->QPushButonMysignalsEnter(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (MyQPushButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQPushButton::QPushButonMysignalsLeave)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (MyQPushButton::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyQPushButton::QPushButonMysignalsEnter)) {
                *result = 1;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject MyQPushButton::staticMetaObject = { {
...
// SIGNAL 0
void MyQPushButton::QPushButonMysignalsLeave()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MyQPushButton::QPushButonMysignalsEnter()
{
